    ...
    inquirer
      ...
      .then((answers) => {
        ...
        const truck = new Truck(
          ...
          parseInt(answers.topSpeed),
          [],
          parseInt(answers.towingCapacity) // Add towing capacity
        );
      ...
      .then((answers) => {
        ...
        // TODO: add statements to perform the wheelie action only if the selected vehicle is a motorbike
          ...
          if (selectedVehicle instanceof Motorbike) {
            // Perform the wheelie action on the motorbike
            console.log(`${selectedVehicle.make} ${selectedVehicle.model} is performing a wheelie!`);
          } else {
